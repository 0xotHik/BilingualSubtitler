...
//Версия 0.2 от 28.06.2015 — Поправлен баг с пересылкой строки в переводчик Яндекса, из-за которого принимались не все субтитры. Поправлен баг с символом # в неположенном месте.
...
//Версия 0.5 от 03.07.2015 — Второй вариант интерфейса, основанный на Panel. Добавлен отдельный класс под структуру субтитра, внутренняя логика программы переделана под него.
